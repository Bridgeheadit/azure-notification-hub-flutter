#import "AzureNotificationHubFlutterPlugin.h"
#import "Constants.h"

@implementation AzureNotificationHubFlutterPlugin {
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"azure_notification_hub_flutter"
            binaryMessenger:[registrar messenger]];
  AzureNotificationHubFlutterPlugin* instance = [[AzureNotificationHubFlutterPlugin alloc] initWithChannel:channel];
