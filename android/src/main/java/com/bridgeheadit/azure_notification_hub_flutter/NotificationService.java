...
public class NotificationService extends FirebaseMessagingService {
    public static final String NOTIFICATION_CHANNEL_ID = "azure_notification_hub_flutter";
    ...
    public static final String ACTION_REMOTE_MESSAGE =
            "com.bridgeheadit.azure_notification_hub_flutter.NOTIFICATION";
    public static final String ACTION_TOKEN = "com.bridgeheadit.azure_notification_hub_flutter.TOKEN";
    public static final String EXTRA_REMOTE_MESSAGE =
            "com.bridgeheadit.azure_notification_hub_flutter.NOTIFICATION_DATA";
    public static final String EXTRA_TOKEN = "com.bridgeheadit.azure_notification_hub_flutter.TOKEN_DATA";
