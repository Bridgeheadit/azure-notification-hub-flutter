...
public class AzureNotificationHubFlutterPlugin extends BroadcastReceiver implements FlutterPlugin, MethodCallHandler {
    ...
    //        AzureNotificationHubFlutterPlugin instance = new AzureNotificationHubFlutterPlugin();
    ...
    private void onAttachedToEngine(Context context, BinaryMessenger binaryMessenger) {
        ...
        channel = new MethodChannel(binaryMessenger, "azure_notification_hub_flutter");
